...
void RecognizerTest::incorrectAccounts()
{
    Recognizer r;
    QVERIFY( r.checkSum("200000000") == false );
    QVERIFY( r.checkSum("333333333") == false );
    QVERIFY( r.checkSum("888888888") == false );
}


void RecognizerTest::correctAccounts()
{
    Recognizer r;
    QVERIFY( r.checkSum("123456789") == true );
    QVERIFY( r.checkSum("490867715") == true );
    QVERIFY( r.checkSum("000000051") == true );
}
